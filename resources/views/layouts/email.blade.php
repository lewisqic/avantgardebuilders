        ...
        <td class="container"
            ...
            <div class="content"
                ...
                <table class="main"
                    ...
                    <tr>
                        <td class="wrapper"
                            style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px; border-bottom: 1px solid #F6F6F6;"
                            valign="top">
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;"
                                        valign="top">
                                        <h2 style="font-weight: 100; margin: 0; color: @yield('heading-color')">@yield('heading')</h2>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td class="wrapper"
                            style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px; border-top: 1px solid #F6F6F6;"
                            valign="top">
                            <table border="0" cellpadding="0" cellspacing="0"
                                   style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;"
                                   width="100%">
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; color: #777;"
                                        valign="top">
                                        Thank You,<br><br>
                                        Avant-Garde Homes
                                    </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td class="content-block"
                            ...
                            <br> Don't want these emails? <a href="#" style="text-decoration: underline; color: #999999; font-size: 12px; text-align: center;">Unsubscribe</a>.
                        </td>
                    </tr>
                </table>
            </div>--}}
