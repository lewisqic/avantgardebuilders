    ...
    <div class="container content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <a href="{{ url('library/Project Questionnaire.pdf') }}" target="_blank" class="btn btn-sm btn-primary"><i class="fal fa-download"></i> Download</a>
            </div>
            <div class="col-sm-3">
                <h4 class="text-ag">Trim Questionnaire</h4>
                <hr>
                <p>Please fill out after the contract is signed.</p>
                <a href="{{ url('library/Trim Questionaire.pdf') }}" target="_blank" class="btn btn-sm btn-primary"><i class="fal fa-download"></i> Download</a>
            </div>
            <div class="col-sm-3">
                <h4 class="text-ag">Sample Draw</h4>
                <hr>
                <p>See an example of what a draw request form looks like.</p>
                <a href="{{ url('library/Sample Draw.pdf') }}" target="_blank" class="btn btn-sm btn-primary"><i class="fal fa-download"></i> Download</a>
            </div>
        </div>
